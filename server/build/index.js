...
const financial_records_1 = __importDefault(
  require("./routes/financial-records")
);
const incomeRecords = require("./routes/income-records");
const budgetRecords = require("./routes/budget-records");
